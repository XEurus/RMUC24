        ...
        try:
            ...
            while len(received_data) == 9:
                ...
                if self.x0!=self.x1 and self.y0!=self.y1 : # 判断发布
                    ...
                    pub_nav = rospy.Publisher('/move_base/goal', PoseStamped, queue_size=10)
...
def publish_initial_pose():
    ...
    # 设置初始位置的坐标
    initial_pose.pose.pose.position.x = 6.0  # 设置x坐标
    initial_pose.pose.pose.position.y = 7.5  # 设置y坐标
...
if __name__ == '__main__':
    ...
    rospy.Subscriber('/cmd_vel', Twist, send.callback1,queue_size=10)  # 创建订阅者，订阅'topic1'话题，回调函数为callback1
